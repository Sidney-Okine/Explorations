...
//  E-commerce
//
//  Created by Mister Okine on 20/02/2022.
//

// Note: The code below was taken from the sample app from https://developer.apple.com/documentation/passkit/apple_pay/offering_apple_pay_in_your_app
import Foundation
import PassKit
...
class PaymentHandler: NSObject {
    ...
    func shippingMethodCalculator() -> [PKShippingMethod] {
        ...
        if let shippingEnd = shippingEnd, let shippingStart = shippingStart {
            ...
            shippingDelivery.detail = "Apple products sent to your address"
